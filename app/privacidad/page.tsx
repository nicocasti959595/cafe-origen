  ...
  return (
    <LegalLayout title="Política de privacidad" updated="Junio 2026">
      ...
      <p>
        ...
        completar el formulario o al escribirnos por WhatsApp o teléfono: nombre,
        número de teléfono, el motivo de tu consulta (reserva, pedido, café en
        grano o evento) y el detalle que nos compartas.
      </p>

      <h2>Para qué los usamos</h2>
      <p>
        Usamos tus datos exclusivamente para responder tu consulta, coordinar y
        confirmar tu reserva o pedido, gestionar la compra de café en grano o un
        evento, y darte seguimiento. No los usamos con fines publicitarios sin tu
        consentimiento.
      </p>
