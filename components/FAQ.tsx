      ...
      <div className="mx-auto max-w-4xl px-4">
            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition ${
                  isOpen ? "border-gold/40 bg-steel/50" : "border-line bg-steel/30"
                }`}
              >
                <button
                ...
                >
                  ...
                  <span
                    className={`grid place-items-center h-7 w-7 shrink-0 rounded-full border border-line text-gold-bright transition ${
        ...
        <p className="mt-10 text-center text-mist">
          ...
          <a
            ...
            className="font-semibold text-gold-bright underline underline-offset-4 hover:text-gold"
          >
