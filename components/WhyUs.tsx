...
export default function WhyUs() {
  return (
    <section id="porque" className="relative py-20 sm:py-28 overflow-hidden">
      <div className="absolute top-1/3 right-0 -z-10 h-96 w-96 rounded-full bg-gold/10 blur-[120px]" />
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="mt-3 font-display text-4xl sm:text-5xl font-bold text-white">
              Del grano a tu taza, sin atajos
            </h2>
            <p className="mt-4 text-mist max-w-lg">
              No somos una cafetería más. Tostamos nuestro propio café, conocemos
              a los productores y cuidamos cada paso para que cada taza valga la
              pena. Eso se nota.
            </p>
            ...
            {whyUs.map((w, i) => {
              ...
              return (
                <Reveal
                  key={w.title}
                  delay={i * 70}
                  className="rounded-2xl border border-line bg-gradient-to-b from-white/[0.05] to-transparent p-6 hover:border-gold/30 transition"
                >
